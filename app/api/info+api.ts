...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,689,946. The last known price of Bitcoin is 63,983.00618923 USD and is down -4.18 over the last 24 hours. It is currently trading on 11018 active market(s) with $31,053,309,339.72 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
