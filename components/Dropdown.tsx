            ...
            <DropdownMenu.Content>
                ...
                <DropdownMenu.Item key="converter">
                    ...
                    <DropdownMenu.ItemIcon
                        ...
                        androidIconName="ic_menu_rotate"></DropdownMenu.ItemIcon>
                </DropdownMenu.Item>
                ...
                <DropdownMenu.Item key="background">
                    ...
                    <DropdownMenu.ItemIcon
                        ...
                        androidIconName="ic_menu_gallery"></DropdownMenu.ItemIcon>
                </DropdownMenu.Item>
                ...
                <DropdownMenu.Item key="account">
                    ...
                    <DropdownMenu.ItemIcon
                        ...
                        androidIconName="ic_secure"></DropdownMenu.ItemIcon>
                </DropdownMenu.Item>
            </DropdownMenu.Content>
        </DropdownMenu.Root>
    );
